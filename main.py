...
def parse_args():
    ...
    parser.add_argument('--img_path', type=str, default='/data/jjm/GAUGAN/DATASET/celebAHQ/train/origin')
    parser.add_argument('--seg_path', type=str, default='/data/jjm/GAUGAN/DATASET/celebAHQ/train/segmen')
    parser.add_argument('--test_img_path', type=str, default='/data/jjm/GAUGAN/DATASET/celebAHQ/test/origin')
    parser.add_argument('--test_seg_path', type=str, default='/data/jjm/GAUGAN/DATASET/celebAHQ/test/segmen')
    # parser.add_argument('--img_path', type=str, default='/data/jjm/GAUGAN/DATASET/cityscape/train/origin')
    # parser.add_argument('--seg_path', type=str, default='/data/jjm/GAUGAN/DATASET/cityscape/train/segmen')
    # parser.add_argument('--test_img_path', type=str, default='/data/jjm/GAUGAN/DATASET/cityscape/test/origin')
    # parser.add_argument('--test_seg_path', type=str, default='/data/jjm/GAUGAN/DATASET/cityscape/test/segmen')
    ...
    parser.add_argument('--lambda_vgg', type=float, default=1, help='weight of vgg loss')
    parser.add_argument('--grid_n_row', type=int, default=5, help='number of row of save image')
    # parser.add_argument('--grid_n_col', type=int, default=4, help='number of col of save image')
    ...
    parser.add_argument('--save_Dis', type=bool, default=False, help='whether save discriminator ckpt with generator')
    parser.add_argument('--start_annealing_epoch', type=int, default=200, help='Learning rate weight decay start point')
    parser.add_argument('--end_annealing_epoch', type=int, default=400, help='Learning rate weight decay end point')
